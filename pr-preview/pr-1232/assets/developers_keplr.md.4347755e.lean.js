...
`),W,n(`
`),X,n(`
`),s("span",Z,[s("span",z,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),J,n(`
`),s("span",Y,[s("span",Q,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
...
`),Is,n(`
`),s("span",Ds,[s("span",Bs,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
...
`),Os,n(`
`),s("span",Ls,[s("span",Ws,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",Xs,[s("span",Zs,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),zs,n(`
`),Js,n(`
`),Ys])]),s("pre",Qs,[s("code",null,[$s,n(`
`),sn,n(`
`),nn,n(`
